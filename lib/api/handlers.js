...
const ANNUAL_FORMULA = 'Estimated annual cost = (monthly premium × 12) + each covered drug’s yearly cost sharing (30-day fills, initial-coverage phase), stopping at the $2,000 out-of-pocket cap. Copays are exact; coinsurance is estimated as your rate × the plan’s negotiated unit price × the quantity you entered — so it’s only as accurate as that quantity. A coinsurance drug with no published price stays out of the total.';
