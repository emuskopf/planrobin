...
async function resultsHandler(db, body) {
  ...
  // Sort: fewest not-covered drugs first (so a plan covering all your drugs beats one
  // missing any, and 3-of-4 beats 1-of-4), then by estimated annual cost ascending.
  plans.sort((a, b) => a.notCovered - b.notCovered || a.annualEstimate - b.annualEstimate);
